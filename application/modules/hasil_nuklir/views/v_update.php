    ...
    <form method="post" action="<?php echo base_url("hasil_nuklir/update/" . $data_hasil_jenis_nuklir->ID_JENIS) ?>">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="form-group">
                        <label for="exampleInputEmail1">ID JENIS PEMERIKSAAN</label>
                        <input type="text" class="form-control" name="ID_JNS_PEMERIKSAAN" value="<?php echo $data_hasil_jenis_nuklir->ID_JNS_PEMERIKSAAN; ?>" >
                    </div>
                </div>
            </div>
    </div>
